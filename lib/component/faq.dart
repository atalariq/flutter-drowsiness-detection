// Source: https://github.com/lakshydeep-14/flutter_faq/blob/main/lib/flutter_faq.dart
// With some modification:
// - Icon as leading instead of trailing
  ...
  Widget _wrapHeader() {
    ...
    children.add(Container(
      ...
      child: ListTile(
        ...
        title: widget.header,
        leading: _isExpanded! ? widget.expandedIcon : widget.collapsedIcon,
